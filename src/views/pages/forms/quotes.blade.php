...
<div class="fcf-body">
    ...
    <div id="fcf-form">
    <h3 class="fcf-h3">Send us Quote</h3>

    <form id="fcf-form-id" class="fcf-form-class" method="post" action="{{ route('quote.store') }}">
        @csrf
        ...
        <div class="fcf-form-group">
            <label for="Email" class="fcf-label">Your company</label>
            <div class="fcf-input-group">
